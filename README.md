...
![The Simpsons TV show](https://res.cloudinary.com/willblake01/image/upload/q_auto/f_auto/v1770242617/portfolio/projects/the-simpsons-memory-challenge.webp)
...
Install Node.js (which includes npm) from the [official Node.js website](https://nodejs.org/en/download/).
...
There are prettier plugins you can install for your editor. See instructions [on the Prettier editor integration page](https://github.com/prettier/prettier#editor-integration).
